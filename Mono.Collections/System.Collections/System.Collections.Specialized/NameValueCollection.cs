...
namespace System.Collections.Specialized
{
    ...
    public class NameValueCollection
    {
        ...
        {
            _collection = new Dictionary<string, IList<string>>(capacity, StringComparer.CurrentCultureIgnoreCase);
        }
        ...
        public NameValueCollection(NameValueCollection col)
        {
            ...
            _collection = new Dictionary<string, IList<string>>(col._collection, StringComparer.CurrentCultureIgnoreCase);
        }
